...
### EXAMPLE 1
```
Get-SdnOvsdbFirewallRuleTable -ComputerName 'Server01','Server02'
```

### EXAMPLE 2
```
Get-SdnOvsdbFirewallRuleTable -ComputerName 'Server01','Server02' -Credential (Get-Credential)
```

### EXAMPLE 3
```
Get-SdnOvsdbFirewallRuleTable -ComputerName 'Server01','Server02' -AsJob
```

### EXAMPLE 4
```
Get-SdnOvsdbFirewallRuleTable -ComputerName 'Server01','Server02' -AsJob -PassThru
```

### EXAMPLE 5
```
Get-SdnOvsdbFirewallRuleTable -ComputerName 'Server01','Server02' -AsJob -PassThru -Timeout 600
```
