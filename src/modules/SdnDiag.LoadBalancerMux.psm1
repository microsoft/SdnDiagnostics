...
function Start-SdnMuxCertificateRotation {
    ...
    .PARAMETER ResourceRef
        The resource reference of the Load Balancer Mux node to perform the certificate rotation on, in format of "/loadBalancerMuxes/{name}". If omitted, the cmdlet will attempt to rotate certificates on all Load Balancer Mux nodes within the fabric.
    .PARAMETER CertPath
