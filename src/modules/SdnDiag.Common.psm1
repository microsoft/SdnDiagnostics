...
function Get-CommonConfigState {
    ...
    try {
        ...
        | Export-ObjectToFile -FilePath $OutputDirectory.FullName -FileType csv -Force
        ...
        ipconfig /allcompartments /all | Export-ObjectToFile -FilePath $OutputDirectory.FullName -Name 'ipconfig_allcompartments' -FileType txt -Force
        ...
        netsh winhttp show proxy | Export-ObjectToFile -FilePath $OutputDirectory.FullName -Name 'netsh_winhttp_show_proxy' -FileType txt -Force
        ...
        foreach ($path in $certificatePaths) {
            ...
            Get-SdnCertificate -Path $path | Export-ObjectToFile -FilePath $OutputDirectory.FullName -Name "Get-SdnCertificate_$($fileName)" -FileType csv -Force
        }
    }
    catch {
        $_ | Trace-Exception
