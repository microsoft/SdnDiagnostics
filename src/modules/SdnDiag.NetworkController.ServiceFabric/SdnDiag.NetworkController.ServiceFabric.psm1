...
Import-Module $PSScriptRoot\SdnDiag.NetworkController.ServiceFabric.Helper.psm1
...
$configurationData = Import-PowerShellDataFile -Path $PSScriptRoot\SdnDiag.NetworkController.ServiceFabric.Config.psd1
