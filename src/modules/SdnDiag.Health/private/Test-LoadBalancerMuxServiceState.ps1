function Test-LoadBalancerMuxServiceState {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        PS> Test-LoadBalancerMuxServiceState
    .EXAMPLE
        PS> Test-LoadBalancerMuxServiceState -ComputerName 'SLB01','SLB02'
    .EXAMPLE
        PS> Test-LoadBalancerMuxServiceState -ComputerName 'SLB01','SLB02' -Credential (Get-Credential)
    #>
