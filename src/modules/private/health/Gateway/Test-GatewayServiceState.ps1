function Test-GatewayServiceState {
    ...
    try {
        ...
        $gateways = $SdnDiagnostics.EnvironmentInfo.Gateway
        ...
        $serviceStateResults = Invoke-PSRemoteCommand -ComputerName $gateways -Credential $credential -Scriptblock $scriptBlock
