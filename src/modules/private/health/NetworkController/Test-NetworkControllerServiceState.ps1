function Test-NetworkControllerServiceState {
    ...
    try {
        ...
        $networkControllers = $SdnDiagnostics.EnvironmentInfo.NC
        ...
        $serviceStateResults = Invoke-PSRemoteCommand -ComputerName $networkControllers -Credential $credential -Scriptblock $scriptBlock
